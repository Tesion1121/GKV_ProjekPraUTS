...
// Posisi kamera dan vektor up (default: tampak depan)
...
// Huruf untuk mengubah tampilan kamera
void normalKeyboard(unsigned char key, int x, int y) {
    switch(key) {
        case 't': // Tampak atas
            camX = 0.0f; camY = 15.0f; camZ = 0.0f;
        ...
        case 'b': // Tampak bawah
            ...
            break;
        case 'l': // Tampak kiri
            camX = -15.0f; camY = 0.0f; camZ = 0.0f;
        ...
        case 'r': // Tampak kanan
            ...
            break;
        case 'f': // Tampak depan
            camX = 0.0f; camY = 0.0f; camZ = 15.0f;
            upX = 0.0f; upY = 1.0f; upZ = 0.0f;
            break;
        case 'k': // Tampak belakang
            camX = 0.0f; camY = 0.0f; camZ = -15.0f;
            upX = 0.0f; upY = 1.0f; upZ = 0.0f;
            break;
    }
